...
router.post('/', async (req, res) => {
    try {
        ...
        await salvarMensagem(sessao.id, 'bot', respostaIA.texto_resposta, respostaIA.telemetria.modelo_usado, respostaIA.telemetria.tokens_prompt, respostaIA.telemetria.tokens_resposta);
        // Salva o novo estado da sessão no banco
        await atualizarSessao(sessao.id, respostaIA.novo_status, respostaIA.dados_coletados, respostaIA.dados_pendentes, respostaIA.agente_atual);
